...
Tot seguit calcularem les variables númeriques amb més correlació amb el preu de l'habitatge.
```{r}
...
Ara mirarem el mateix però només amb les variables categòriques.
Primer de tot pasem les 6 variables categòriques a factors.
...
anova_result_kitchen
anova_result_energy
anova_result_heating
anova_result_city
anova_result_state
```
```{r}
